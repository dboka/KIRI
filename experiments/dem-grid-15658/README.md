...
- krāsaina RESTRICTION riska virsma uz 3D reljefa;
- atsevišķi ieslēdzami LAD, augsnes, ūdens aizsardzības un meliorācijas slāņi;
- atsevišķi ieslēdzama LVĢMC upju sateces baseina robeža;
- izcelta meliorācijas hierarhija: novadgrāvji, grāvji, kolektori un drenas;
- sinhrona noteces trajektoriju animācija ar vienādu kustības tempu;
- punktota 1 × 1 km analīzes šūnas robeža un 500 m konteksta robeža;
...
Eksportētajā skatā var grozīt un pietuvināt reljefu, pārslēgt analīzes slāņus,
apturēt noteces animāciju un atjaunot sākuma skatu. Meliorācijas ūdensteču asis
3D skatā apzināti netiek attēlotas, lai nedublētu ūdens aizsardzības slāņus.
